...
import { getAllGuides, getAllComparisonIds, getComparisonContent, WEBSITE_TITLE } from '@/lib/utils';
...
export async function generateMetadata({params}) {
    const comparisonData = await getComparisonContent(params.code, "guides");
    return {
        ...
        openGraph: {
            title: "CodeClash: " + comparisonData.title,
            description: comparisonData.description,
            url: 'https://code-clash.net/guides/' + params.code,
